# src/Agent.md — 작업 가이드 (코드 작성 규칙)

이 문서는 이 템플릿으로 **실제 플러그인을 만들 때** 지켜야 할 규칙을 정의합니다.
루트 구조/실행 흐름은 [`../Agent.md`](../Agent.md) 를 먼저 참고하세요.
...
- 자세한 내용: 루트 [`../Agent.md`](../Agent.md) 의 "개발용 인증 우회".

---

## 5. 새 기능 추가 체크리스트

1. [ ] `src/Agent.md` 0항(작업 대상 프로젝트 정의)에 기능 내용 기록
