# src/Agent.md — Work Guide (code-writing rules)

This document defines the rules to follow when **actually building a plug-in** with this template.
For the root structure / entry flow, see [`../Agent.md`](../Agent.md) first.
...
- Details: "Dev auth bypass" in the root [`../Agent.md`](../Agent.md).

---

## 5. New-feature checklist

1. [ ] Record the feature in section 0 (target project definition) of `src/Agent.md`
